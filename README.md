...
📋 **See [PRODUCTION_READINESS.md](docs/planning/PRODUCTION_READINESS.md) for deployment checklist**
...
All project docs are organized under [`docs/`](docs/README.md) by topic —
setup, deployment, Firebase, Google Cloud, implementation notes, planning, and
reviews. Start at the [documentation index](docs/README.md).
