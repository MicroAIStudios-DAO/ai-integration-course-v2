...
// Route-level code splitting: every page below the conversion-critical root is
// lazy-loaded so the initial bundle only ships the app shell + landing page.
// NewLandingPage (root) and Layout stay eager to avoid a Suspense flash on the
// primary entry point.
...
// Lightweight fallback shown while a lazy route chunk is fetched.
