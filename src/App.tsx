...
import Layout from './components/layout/Layout'; // App shell — kept eager
import NewLandingPage from './pages/NewLandingPage'; // Root funnel entry — kept eager for fast LCP
import { UserJotWidget } from './components/UserJotWidget';
import ConsentBanner from './components/ConsentBanner';
import ExitIntentModal from './components/ExitIntentModal';
import { initGA4, trackPageView } from './utils/analytics';

// Route-level code splitting: every non-landing page loads on demand so the
// initial bundle only carries the app shell + landing page. Each lazy import
// becomes its own chunk emitted by Rollup.
